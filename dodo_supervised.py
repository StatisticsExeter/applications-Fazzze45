...
from course.supervised_classification.roc_curve import roc_curve
...
def task_roc_curve():
    return {
        ...
        'targets': [
            'data_cache/vignettes/supervised_classification/roc_lda.png',
            'data_cache/vignettes/supervised_classification/roc_qda.png',
        ],
    }
